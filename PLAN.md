...
## Mevcut durum (özet)
- **LIVE** ($487 gerçek): **v4.7 CANLI** — `GÜVENE GÖRE $100-300` (60-69→$100, 70-79→$150, 80-89→$200, 90+→$300), kill %5, floor $414.
...
- ⚠️ Bilinen açık konular (rapor edildi, İhsan kararı bekliyor): R:R gate fiilen
  ATR≤%2.22 filtresi; koordinatör güveni yön-bağımsız; rejim EMA200'ü saatlik
  barda; ters-ETF özelliği tarama evreninde yok (ölü); earnings gate verisi
  güvenilmez; SignalQueue hiç beslenmiyor; yarım-gün takvimi yok.
